#!/usr/bin/env node
/**
 * gen-product-pdf-live.js
 * Loads the live product deck at https://aetherum.ai/product.html via Puppeteer
 * and prints aetherum-product.pdf.
 */
...
(async () => {
  ...
  console.log('Loading https://aetherum.ai/product.html ...');
  await page.goto('https://aetherum.ai/product.html', {
